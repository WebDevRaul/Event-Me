...
const select_error_state = state => state.error.user.error;
const select_loading_state = state => state.loading.user.isLoading;
...
export const state_user_loading = createSelector(
